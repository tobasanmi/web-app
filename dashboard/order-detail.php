		  ...
		  $msgcounter = mysqli_num_rows($result);
  		 ...
  		 if ($msgcounter == 0) {
			 ...
			 $msgcount= $msgcounter;
	     	  ...
	     	  $sqlx = "SELECT * FROM msg WHERE state ='new'";
       ...
       <div class="col-md-6 col-md-offset-3">
                <div class="login-panel panel panel-default">
                        <div class="panel-heading" style="background-color:#B1C4FF">
                            <h3 class="panel-title" style="font-size:12px; color:#ffffff;"><center><b>Total Messages: <span><?php echo $msgcounterx; ?></span></b></center></h3>
                        </div>
