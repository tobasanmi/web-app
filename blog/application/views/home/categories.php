<main class="main-content">
                         ...
                         <div class="col-md-6">
                             <div class="blog-img img-zoom-effect h-100">
                                 <a href="'.base_url("post/".$result[$num]['id']).'?'.$result[$num]['slug'].'">
                                     <img class="img-full h-100" src="https://blog.daydone.com.ng/backend/wp-content/uploads/'.$result[$num]['better_featured_image']['media_details']['file'].'" alt="Blog Image">
                                 </a>
                             </div>
                         </div>
                         <div class="col-md-6">
        ...
        fetch_specific_category().then(data => {
         data.forEach(function (item, index) {
           ...
           categories +='<div class="product-list-item"> <div class="product-img img-zoom-effect"> <a href="<?php echo base_url();?>posts/'+data[index].id+'?'+ data[index].slug+'"> <img class="img-full" src="'+data[index].jetpack_featured_media_url+'" alt="Blog Images"> </a> </div> <div class="product-content"> <h5 class="title mb-3"> <a href="<?php echo base_url();?>posts/'+data[index].id+'?'+ data[index].slug+'">'+ data[index].title.rendered+'</a> </h5> <div class="blog-meta text-manatee pb-1"> <ul> <li class="date">'+ truncateString(data[index].date, 10)+'</li> </ul> </div> </div> </div><br>'; 
        });
