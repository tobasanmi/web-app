<main class="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-3 order-2 pt-10 pt-lg-0">
                            <div class="sidebar-area">
                                ...
                                <div class="widgets-area mb-9">
                                    <h2 class="widgets-title mb-5">TRENDING</h2>
                                    <div class="widgets-item">
                         ...
                         <div class="col-md-6">
                             <div class="blog-img img-zoom-effect h-100">
                                 <a href="'.base_url("post/".$posts[$num]['id']).'?'.$posts[$num]['slug'].'">
                                   <img class="img-full h-100" src="https://daydone.com.ng/blog/writer/wp-content/uploads/'.$posts[$num]['better_featured_image']['media_details']['file'].'" alt="Blog Image">
    ...
    async function fetch_specific_category() {
          const response = await fetch('https://daydone.com.ng/blog/writer/wp-json/wp/v2/posts?categories=2');
