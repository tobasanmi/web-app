...
class Home extends CI_Controller {
	...
	{
		 $url_author= "https://daydone.com.ng/blog/writer/wp-json/wp/v2/users/1";
		 $data['author']  = json_decode(file_get_contents($url_author), true);
		 $url = "https://daydone.com.ng/blog/writer/wp-json/wp/v2/posts?_embed";
	...
	{
		$url = "https://daydone.com.ng/blog/writer/wp-json/wp/v2/posts/".$id."?_embed";
	...
	{    
	    ...
	    $url = "https://daydone.com.ng/blog/writer/wp-json/wp/v2/posts?search=".$query;
	...
	{    
		$url_author= "https://daydone.com.ng/blog/writer/wp-json/wp/v2/users/1";
		$data['author']  = json_decode(file_get_contents($url_author), true);
	    $url = "https://daydone.com.ng/blog/writer/wp-json/wp/v2/posts?categories=".$id;
		$data['result']  = json_decode(file_get_contents($url), true);
		$this->load->view('home/header');
