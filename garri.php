...
<div class="single">
 ...
 <div class="col-md-7" align="right">
                                <button style="right" class="btn btn-danger my-cart-btn my-cart-b" data-id="<?= $fetch_product_details['product_id']; ?>" data-name="<?= $fetch_product_details['product_name']; ?>" data-summary="summary 1" data-price="<?= $fetch_product_details['price']; ?>" data-quantity="1" data-image="dashboard/<?= $fetch_product_details['product_img']; ?>"><h4>Add to cart</h4></button></p>
            </div>
    ...
    <div class="container ">
        ...
        <div class="row" id="commentz">
            <?php
				...
				?>
				<div class="card shadow col-md-5 well" style="text-align:left; padding:20px; margin-right:30px; height:120px;">
