...
<!-- End Facebook Pixel Code -->
    ...
    <meta name="keywords" content="DayDone, DayDone Limited, Online Farm Produce in Nigeria,Nigeria Online Garri Mall, Farm/Agric produces in Nigeria, Fresh Garri Delivery, Garri eCommerce, eCommerce for processed cassava, Number one cassava flakes in Nigeria, Number one garri store in nigeria, Foodstuff ecommerce website, garri website in nigeria, Garri Shop Point, Cassava processing, Agricultural Produce in Nigeria, Food Items Online, Cassava Flakes, ecommerce, cheap cassava, Best agric ecommerce platform, Best agric ecommerce platform in Nigeria, Farm Mall" />
    <meta name="author" content="DayDone LLC" />
    <meta name="twitter:card" content="DayDone Ltd" />
    <meta name="twitter:titles" content="Garri ecommerce Platform" />
    ...
    <div class="header">
            ...
            <div class="header-ri">
                <ul class="social-top">
                    ...
                    <li><a href="https://www.instagram.com/daydoneng/" class="icon instagram"><i class="fa fa-instagram" aria-hidden="true"></i><span></span></a></li>
...
<script>
	window.jQuery || document.write('<script src="assets/rateit/jquery.rateit.js"><\/script>')
</script>
<script src="assets/rateit/jquery.rateit.js"></script>
