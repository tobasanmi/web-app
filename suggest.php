...
<div class="banner-top">
	<div class="container">
		...
		<h4><a href="./">Home</a><label>/</label>Suggest Product</h4>
		...
		<div class="container">
		     <div class="spec ">
				<h2>Suggest Product</h2>
					...
					<br>
					<br>
					 <h3>Products Recommendation</h3><h5>This is for products you will desire to see and purchase, this information will be use to get new featured product</h5>
					 <br>
					 <br>
			<div class="form-w3agile">
			    <div class="row">
                   ...
                   oninput="InvalidMsg(this);" placeholder="Email Address" required>
			                   ...
			                   <div class="form-group">
			                       <input type="text" name="region" id="region" class="form-control" placeholder="Product Region">
			                       <div class="text-danger pull-left" id="error_region"></div>
			                   </div>
			                   <button class="pull-left btn btn-lg btn-success" type="button" name="submit_btn" id="submit_btn">Submit</button>
			               </form>
