                    ...
                    <div class="single-special text-center wow fadeInUp" data-wow-delay="0.2s" style="box-shadow: 2px 3px 5px; border-radius: unset;">
                        <div class="px-3 py-4 bg-white">
                            ...
                            <div class="">                            
                                ...
                                <div class="term-body">
                                   ...
                                   <hr>
                                    ...
                                    <div class="content">
										...
										<p><b>Note</b> that <span style="font-weight: 700;">communication of product number of stock</span> is essential. And every activated account is expected to put out their <span style="font-weight: 700;">best of price.</span> Payment will be made after successful delivery</p>                                      
                                    </div>  
                                ...
                                <p><br><p>This terms was last updated on December 31, 2021.</p>
                            </div>
                        </div>
                    </div>
                </div>
